...
def issuebook_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            obj.user = form.cleaned_data['enrollment2']
...
def viewissuedbook_view(request):
    ...
    for ib in issuedbooks:
        ...
        students=list(models.StudentExtra.objects.filter(user=ib.user.user))
        i=0
        for l in books:
...
def viewissuedbookbystudent(request):
    ...
    issuedbook=models.IssuedBook.objects.filter(user=student[0])
